...
export const STORY_ADVENTURE_WORLDS: Record<StoryAdventureWorldId, StoryHubDefinition> = {
  ...
  greenhollow: region({
    id: 'greenhollow', subtitle: 'A lively settlement at the edge of the old forest', theme: 'village', width: 560, regulars: ['volt-slime', 'nightshade-bulb', 'venom-slime'],
  ...
  thornwood: region({
    id: 'thornwood', subtitle: 'Ancient roots hide restless creatures', theme: 'forest', width: 600, regulars: ['nightshade-bulb', 'venom-slime', 'veil-shade'],
  ...
  ironroot: region({
    id: 'ironroot', subtitle: 'Ore-lit tunnels beneath the world route', theme: 'mine', width: 640, regulars: ['graveblade', 'tide-slime', 'volt-slime'],
  ...
  bonevault: region({
    id: 'bonevault', subtitle: 'A sealed crypt filled with roaming skeleton crews', theme: 'crypt', width: 520, regulars: ['graveblade', 'veil-shade', 'magma-slime'],
  ...
  emberdeep: region({
    id: 'emberdeep', subtitle: 'A volcanic underworld of fire and hidden relics', theme: 'underworld', width: 620, regulars: ['cinder-wisp', 'magma-slime', 'nightshade-bulb'],
  ...
  frostpeak: region({
    id: 'frostpeak', subtitle: 'A frozen climb through bright mountain winds', theme: 'snow', width: 560, regulars: ['tide-slime', 'veil-shade', 'graveblade'],
  ...
  sunscar: region({
    id: 'sunscar', subtitle: 'Shifting dunes surrounding a buried road', theme: 'desert', width: 640, regulars: ['volt-slime', 'cinder-wisp', 'magma-slime'],
  ...
  skyglass: region({
    id: 'skyglass', subtitle: 'Floating platforms and unstable ancient traps', theme: 'ruins', width: 480, regulars: ['tide-slime', 'venom-slime', 'cinder-wisp'],
