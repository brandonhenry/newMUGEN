...
const CONFIG: Record<StoryEnemyId, Omit<StoryEnemyDefinition, 'id' | 'label' | 'tier' | 'animations'>> = {
  ...
  graveblade: { archetype: 'ground', behavior: 'chaser', worldScale: 0.92, visualHeight: 2.9, hitbox: [0.52, 0.78], healthMultiplier: 1.12, damageMultiplier: 1.05, speedMultiplier: 1.05, xpMultiplier: 1.05, attacks: [melee('attack-1', 0.9, 1.1, 900), melee('attack-2', 1.15, 1.35, 1_200), projectile('special', '#f0b070', 1, 1_900)] },
  'tide-slime': { archetype: 'ground', behavior: 'chaser', worldScale: 0.78, visualHeight: 1.45, hitbox: [0.55, 0.45], healthMultiplier: 0.88, damageMultiplier: 0.9, speedMultiplier: 1.08, xpMultiplier: 0.9, attacks: [melee('attack-1', 0.85, 1.15, 850), melee('attack-2', 1, 1.25, 1_100)] },
  'venom-slime': { archetype: 'ground', behavior: 'ambusher', worldScale: 0.78, visualHeight: 1.45, hitbox: [0.55, 0.45], healthMultiplier: 0.92, damageMultiplier: 0.95, speedMultiplier: 1, xpMultiplier: 0.95, attacks: [melee('attack-1', 0.85, 1.15, 900), melee('attack-3', 1.05, 1.3, 1_200)] },
  'volt-slime': { archetype: 'ground', behavior: 'chaser', worldScale: 0.78, visualHeight: 1.45, hitbox: [0.55, 0.45], healthMultiplier: 0.85, damageMultiplier: 1.05, speedMultiplier: 1.22, xpMultiplier: 1, attacks: [melee('attack-1', 0.8, 1.2, 760), melee('attack-4', 1.1, 1.35, 1_150)] },
  'magma-slime': { archetype: 'ground', behavior: 'bruiser', worldScale: 0.82, visualHeight: 1.55, hitbox: [0.58, 0.48], healthMultiplier: 1.2, damageMultiplier: 1.15, speedMultiplier: 0.9, xpMultiplier: 1.1, attacks: [melee('attack-1', 0.9, 1.2, 950), melee('attack-3', 1.2, 1.4, 1_350)] },
  'ember-fist': { archetype: 'ground', behavior: 'duelist', worldScale: 1.08, visualHeight: 3.25, hitbox: [0.58, 0.95], healthMultiplier: 4.5, damageMultiplier: 1.5, speedMultiplier: 1.12, xpMultiplier: 6, attacks: [melee('attack-1', 0.9, 1.2, 800), melee('attack-2', 1.1, 1.35, 1_050), melee('attack-3', 1.35, 1.55, 1_350)] },
  'dusk-ronin': { archetype: 'ground', behavior: 'duelist', worldScale: 1.08, visualHeight: 3.3, hitbox: [0.58, 0.98], healthMultiplier: 4.5, damageMultiplier: 1.5, speedMultiplier: 1.05, xpMultiplier: 6, attacks: [melee('attack-1', 1, 1.55, 900), melee('attack-2', 1.2, 1.75, 1_150), melee('attack-3', 1.45, 1.9, 1_450)] },
  'crescent-rogue': { archetype: 'ground', behavior: 'duelist', worldScale: 1.08, visualHeight: 3.2, hitbox: [0.6, 0.95], healthMultiplier: 4.25, damageMultiplier: 1.45, speedMultiplier: 1.25, xpMultiplier: 6, attacks: [melee('attack-1', 0.85, 1.45, 720), melee('attack-2', 1.1, 1.65, 980), melee('attack-3', 1.35, 1.8, 1_250)] },
  'chimera-android': { archetype: 'ground', behavior: 'bruiser', worldScale: 1.08, visualHeight: 3.55, hitbox: [0.62, 0.98], healthMultiplier: 4.8, damageMultiplier: 1.55, speedMultiplier: 0.98, xpMultiplier: 6, attacks: [melee('attack-1', 0.95, 1.35, 900), melee('attack-3', 1.35, 1.55, 1_350), melee('attack-4', 1.55, 1.7, 1_700)] },
  'silver-duelist': { archetype: 'ground', behavior: 'duelist', worldScale: 1.1, visualHeight: 3.3, hitbox: [0.58, 1], healthMultiplier: 4.25, damageMultiplier: 1.5, speedMultiplier: 1.18, xpMultiplier: 6, attacks: [melee('attack-1', 0.9, 1.75, 760), melee('attack-2', 1.1, 2, 980), melee('attack-3', 1.35, 2.15, 1_300)] },
  'crimson-countess': { archetype: 'ranged', behavior: 'caster', worldScale: 1.1, visualHeight: 3.4, hitbox: [0.62, 1], healthMultiplier: 4.35, damageMultiplier: 1.5, speedMultiplier: 0.95, xpMultiplier: 6, attacks: [melee('attack-1', 0.9, 1.4, 900), projectile('attack-2', '#e33558', 1.1, 1_250), projectile('attack-4', '#ff4a72', 1.4, 1_750)] },
  'laughing-oni': { archetype: 'ground', behavior: 'bruiser', worldScale: 1.12, visualHeight: 3.8, hitbox: [0.64, 1], healthMultiplier: 5, damageMultiplier: 1.6, speedMultiplier: 0.92, xpMultiplier: 6.25, attacks: [melee('attack-1', 0.95, 1.25, 900), melee('attack-2', 1.25, 1.45, 1_250), melee('special', 1.5, 1.75, 1_700)] },
...
export function storyEnemyPlaneSize(enemy: StoryEnemyDefinition): number {
  const idleFrame = enemy.animations.find((animation) => animation.id === 'idle')?.frames[0];
  const contentHeight = idleFrame ? idleFrame.contentBounds[3] - idleFrame.contentBounds[1] : STORY_ENEMY_FRAME_SIZE.height;
  return enemy.visualHeight * STORY_ENEMY_FRAME_SIZE.height / Math.max(1, contentHeight);
}
