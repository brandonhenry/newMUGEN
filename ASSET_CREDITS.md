...
The starter fighters use 2D source art, then render as chunky sprite-voxel 3D fighters at runtime.

- `public/characters/kiro/source.png`: User-provided prototype character image used for Kiro's image-to-voxel extraction. Do not publish this asset publicly unless the project owner confirms they have rights to use and distribute it.
